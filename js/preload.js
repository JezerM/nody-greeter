...
class Greeter {
    constructor() {
        this.authentication_complete = new Signal("authentication-complete");
        this.autologin_timer_expired = new Signal("autologin_timer-expired");
        this.idle = new Signal("idle");
        this.reset = new Signal("reset");
        this.show_message = new Signal("show-message");
        this.show_prompt = new Signal("show-prompt");
